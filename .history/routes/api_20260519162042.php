...
use App\Http\Controllers\Api\NewEmployeeController;
use App\Http\Controllers\BirthdaySettingsController;
use App\Http\Controllers\Settings\FridayReportSettingsController;
use App\Http\Controllers\Settings\MondayProcessSettingsController;
use App\Http\Controllers\Api\NewEmployeeReportConfigController;   // Correo 1 (General)
use App\Http\Controllers\Api\NewEmployeeReportRhConfigController; // Correo 2 (RH - Con Datos)
use App\Http\Controllers\Api\NoNewEmployeeReportRhConfigController; // Correo 3 (RH - Sin Datos)
